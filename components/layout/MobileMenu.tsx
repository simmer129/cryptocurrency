      ...
      >
        <ul id="menu-primary-menu" className="menu">
          ...
          >
            ...
            >
              <li
                className={`menu-item ${checkCurrentMenuItem("/sell-crypto")}`}
              >
          ...
          >
            ...
            >
              <li
                className={`menu-item ${checkCurrentMenuItem("/blog-default")}`}
              >
                <Link href="/blog-default">Blog Default</Link>
              </li>
              <li
                className={`menu-item ${checkCurrentMenuItem("/blog-grid-v1")}`}
              >
                <Link href="/blog-grid-v1">Blog Grid v1</Link>
              </li>
              <li
                className={`menu-item ${checkCurrentMenuItem("/blog-grid-v2")}`}
              >
          ...
          >
            ...
            <ul
              className="sub-menu"
              style={{ display: `${isActive === 5 ? "block" : "none"}` }}
            >
              <li
                className={`menu-item ${checkCurrentMenuItem("/user-profile")}`}
              >
