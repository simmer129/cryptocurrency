            ...
            <div className="row">
              <div className="col-xl-4 col-md-6">
                <div className="info">
                  <Link href="/" className="logo">
                    <img
                      src="/assets/images/logo/log-footer.png"
                      alt="Footer Logo"
                    />
                  </Link>
                  <h6>Let's talk! 🤙</h6>
                  <ul className="list">
                    ...
                    <li>
                      <p>
                        Cecilia Chapman 711-2880 Fuck St. Mankato Mississippi
                        96522
                      </p>
                    </li>
                  </ul>
                ...
                <div className="widget">
                  <div className="widget-link">
                    ...
                    <ul>
                      ...
                      <li>
                        <Link href="#">Inverse Perpetual</Link>
                      </li>
                      <li>
                        <Link href="#">USDT Perpetual</Link>
                      </li>
                      <li>
              ...
              <div className="col-xl-4 col-md-12">
                <div className="footer-contact">
                  <h5>Newsletter</h5>
                  <p>
                    Subscribe to our newsletter to get more free design courses
                    and resources.
                  </p>
                  <form>
                    <input
